      ...
      <h2 className="mt-8 font-display font-semibold text-lg flex items-center justify-between">
        ...
        <div className="flex items-center gap-3 text-xs font-normal">
          <span className="flex items-center gap-1">
            <div className="size-2 rounded-full bg-secondary border border-border"></div> Free
          </span>
          <span className="flex items-center gap-1">
            <div className="size-2 rounded-full bg-amber-400"></div> Reserved
          </span>
          <span className="flex items-center gap-1">
            <div className="size-2 rounded-full bg-red-500"></div> Occupied
          </span>
        </div>
      </h2>
